...
//			VRTRIXEvents.DeviceConnected.Listen(OnDeviceConnected); // Usually in OnEnable
//			VRTRIXEvents.DeviceConnected.Remove(OnDeviceConnected); // Usually in OnDisable
//
// Alternatively, if Listening/Removing often these can be cached as follows:
//
//			VRTRIXEvents.Action deviceConnectedAction;
//			void OnAwake() { deviceConnectedAction = VRTRIXEvents.DeviceConnectedAction(OnDeviceConnected); }
...
namespace VRTRIX
{
    public static class VRTRIXEvents
    {
