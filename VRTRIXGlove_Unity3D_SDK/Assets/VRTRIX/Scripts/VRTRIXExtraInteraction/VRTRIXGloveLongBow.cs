...
//
// Purpose: LongBow class should be attached to bow objects if you want VR
//          interaction with bows/arrows using VRTRIX Data Glove.
//			Update Required.
//
//=============================================================================
using UnityEngine;
...
namespace VRTRIX
{
    ...
    public class VRTRIXGloveLongBow : MonoBehaviour
    {
        ...
        private void HandAttachedUpdate(VRTRIXGloveGrab hand)
        {
            ...
            if (nocked)
            {
                ...
                Vector3 arrowNockTransformToHeadset = ((VRTRIXGlovePlayer.instance.hmdTransform.position + (Vector3.down * 0.05f)) - arrowHand.arrowNockTransform.parent.position).normalized;
        ...
        private void ShutDown()
        {
            ...
            {
                if (hand.otherHand.currentAttachedObject.GetComponent<VRTRIXGloveItemPacakgeReference>() != null)
                {
                    if (hand.otherHand.currentAttachedObject.GetComponent<VRTRIXGloveItemPacakgeReference>().itemPackage == arrowHandItemPackage)
                    {
