...
//
// Purpose: Examples to creat a teleport point (locke & unlocked).
//
//=============================================================================
using UnityEngine;
...
{
    //-------------------------------------------------------------------------
    public class VRTRIXGloveTelportPoint : VRTRIXTeleportMarkerBase
    {
        ...
        private VRTRIXGlovePlayer player;
        ...
        void Start()
        {
            player = VRTRIXGlovePlayer.instance;
        }
        ...
        public override void Highlight(bool highlight)
        {
            if (!locked)
            {
                if (highlight)
                {
                    SetMeshMaterials(VRTRIXGloveTeleport.instance.pointHighlightedMaterial, titleHighlightedColor);
                }
                else
                {
                    SetMeshMaterials(VRTRIXGloveTeleport.instance.pointVisibleMaterial, titleVisibleColor);
                }
            }
        ...
        public override void UpdateVisuals()
        {
            ...
            if (locked)
            {
                SetMeshMaterials(VRTRIXGloveTeleport.instance.pointLockedMaterial, titleLockedColor);
        ...
        public void UpdateVisualsInEditor()
        {
            ...
            if (locked)
            {
                ...
                markerMesh.sharedMaterial = VRTRIXGloveTeleport.instance.pointLockedMaterial;
                lockedIcon.sharedMaterial = VRTRIXGloveTeleport.instance.pointLockedMaterial;
            ...
            else
            {
                ...
                markerMesh.sharedMaterial = VRTRIXGloveTeleport.instance.pointVisibleMaterial;
                switchSceneIcon.sharedMaterial = VRTRIXGloveTeleport.instance.pointVisibleMaterial;
                moveLocationIcon.sharedMaterial = VRTRIXGloveTeleport.instance.pointVisibleMaterial;
...
#if UNITY_EDITOR
    //-------------------------------------------------------------------------
    [CustomEditor(typeof(VRTRIXGloveTelportPoint))]
